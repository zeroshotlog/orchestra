...
3. Since the app is not signed with an Apple Developer certificate, allow it to open using either method:
   - **System Settings**: Open **System Settings → Privacy & Security**, scroll down and click **"Open Anyway"** next to the blocked app message.
